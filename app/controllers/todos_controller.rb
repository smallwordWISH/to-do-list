class TodosController < ApplicationController
  ...
  def index
    ...
    # a = asc_date_todos.pluck(:due_date)

    # uniq_date_array = a.select{ |e| a.count(e) > 0 }.uniq

    # for i in 0...uniq_date_array.length
    #   @todos = Todo.where(due_date: uniq_date_array[i])
    # end
